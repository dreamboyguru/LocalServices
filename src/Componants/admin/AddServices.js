...
const AddServices = () => {
            ...
            <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-800 backdrop-blur-sm bg-opacity-75">
                <div className='relative bg-white h-auto shadow-md p-5 w-96 items-center justify-center rounded'>
                    ...
                    <form>
                        ...
                        <input type="text" id="service-name" className="py-2 mt-1 block w-full border-2 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"/>
                        </div>
                        <div className="mb-6">
                        <label htmlFor="service-file" className="block text-lg font-bold text-gray-700">Service File</label>
                        <input type="file" id="service-file" className="py-2 mt-1 block w-full border-2 border-gray-300 rounded-md shadow-sm sm:text-sm"/>
                        </div>
                        <div>
  ...
  return (
    <div className='flex flex-wrap justify-center h-auto text-2xl w-full text-black font-serif'>
      ...
      <div className='relative' onClick={()=>setAddServiceBox(false)}>{addServiceBox && showAddAerviceBox()}</div>
