...
function Footer() {
    return (
        <footer className="max-md:fixed bottom-0 w-full bg-gray-700 py-6 text-gray-400">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="md:flex md:items-center md:justify-between">
                    ...
                    <a href="tel:your-phone-number" className="hover:text-gray-100">
                        <MdPhone />
                    </a>
                    <a href="mailto:your-email@example.com" className="hover:text-gray-100">
                        <MdEmail />
                    </a>
                    <a
