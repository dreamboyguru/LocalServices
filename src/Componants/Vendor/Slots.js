...
const Slots = () => {
  return (
    <div className='min-h-96 text-2xl w-full text-black overflow-x-auto'>
        <table className="min-w-full border-collapse border border-gray-300 shadow-lg">
            <thead>
                <tr className="bg-gray-500 text-white max-md:text-lg">
        ...
        <button type='Submit' className='bg-gray-500 hover:bg-gray-600 text-white items-end rounded-md p-2 px-8 mr-16 max-md:mr-1 max-md:px-4 max-md:text-lg hover:scale-105 duration-300'>Submit</button>
  </div>
